...
kmdf1_11 = [
	...
	("WdfRegistryOpenKey","typedef NTSTATUS __fastcall WDF_REGISTRY_OPEN_KEY(int, WDFKEY ParentKey, _UNICODE_STRING *KeyName, ULONG DesiredAccess, _WDF_OBJECT_ATTRIBUTES *KeyAttributes, WDFKEY *Key);"),
